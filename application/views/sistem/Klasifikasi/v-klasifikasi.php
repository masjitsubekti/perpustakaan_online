<div class="row">
    <div class="col-12">
        <div class="card shade">
            <div class="card-body">
                <h4 class="card-title" style="font-size:17px;"> <i class="bx bx-layer"></i> Klasifikasi</h4>
                <br>
                <!--  -->
                <div class="row">
                    <div class="col-md-6">
                        <a href="javascript:;" class="btn btn-success" id="btn-add"> <b> <i class="bx bx-plus-circle"></i> </b> Tambah</a>
                    </div>
                    <div class="col-md-2">
...
<script>
  ...
  $('#cari').on('keypress', function (e) {
    ...
    var sort = $('#input_sort').val();
		...
		var cari = $('#cari').val();
		$.ajax({
			url: "<?php echo site_url('Klasifikasi/read_data/')?>" + i,
			type: 'post',
			dataType: 'html',
			data: {
				limit: limit,
