            ...
            <div class="card-body">
                                ...
                                <div class="col-md-2 col-sm-3 col-4">
                                    <div class="nav flex-column nav-pills " id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        <a class="nav-link active" id="product-1-tab" data-toggle="pill" href="#product-1" role="tab" aria-controls="product-1" aria-selected="true">
                                            <img src="<?= base_url() ?>assets/themes/images/product/img-7.png" alt="" class="img-fluid mx-auto d-block rounded">
                                        </a>
                                        <a class="nav-link" id="product-2-tab" data-toggle="pill" href="#product-2" role="tab" aria-controls="product-2" aria-selected="false">
                                            <img src="<?= base_url() ?>assets/themes/images/product/img-8.png" alt="" class="img-fluid mx-auto d-block rounded">
                                        </a>
                                ...
                                <div class="col-md-7 offset-md-1 col-sm-9 col-8">
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="product-1" role="tabpanel" aria-labelledby="product-1-tab">
                                            <div>
                                                <img src="<?= base_url() ?>assets/themes/images/product/img-7.png" alt="" class="img-fluid mx-auto d-block">
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="product-2" role="tabpanel" aria-labelledby="product-2-tab">
                                            <div>
                                                <img src="<?= base_url() ?>assets/themes/images/product/img-8.png" alt="" class="img-fluid mx-auto d-block">
                                            </div>
                                        </div>
                            ...
                            <div class="product-color">
                                ...
                                <a href="#" class="active">
                                    <div class="product-color-item border rounded">
                                        <img src="<?= base_url() ?>assets/themes/images/product/img-7.png" alt="" class="avatar-md">
                                    </div>
                                    <p>Black</p>
                                </a>
                                <a href="#">
                ...
                <!-- <div class="mt-5">
                    ...
                    <div class="media py-3 border-bottom">
                        <img src="<?= base_url() ?>assets/themes/images/users/avatar-2.jpg" class="avatar-xs mr-3 rounded-circle" alt="img" />
                    ...
                    <div class="media py-3 border-bottom">
                        <img src="<?= base_url() ?>assets/themes/images/users/avatar-4.jpg" class="avatar-xs mr-3 rounded-circle" alt="img" />
                        <div class="media-body">
                            ...
                            <div class="media mt-4">
                                <img src="<?= base_url() ?>assets/themes/images/users/avatar-5.jpg" class="avatar-xs mr-3 rounded-circle" alt="img" />
                                <div class="media-body">
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-4">
                                    <img src="<?= base_url() ?>assets/themes/images/product/img-4.png" alt="" class="img-fluid mx-auto d-block">
                                </div>
                                <div class="col-md-8">
                                    <div class="text-center text-md-left pt-3 pt-md-0">
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-4">
                                    <img src="<?= base_url() ?>assets/themes/images/product/img-6.png" alt="" class="img-fluid mx-auto d-block">
                                </div>
                                <div class="col-md-8">
                                    <div class="text-center text-md-left pt-3 pt-md-0">
