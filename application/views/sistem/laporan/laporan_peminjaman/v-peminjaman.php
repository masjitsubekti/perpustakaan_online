...
<script>
    ...
    $("#btn-add").click(function() {
		...
		$.ajax({
			...
			success: function (result) {
				...
				$('#modeform').val('ADD');
				$('#modal-color').addClass('modal-success');
				$('#modal').modal('show');
			}
		});
  });
  ...
  function refresh(){
	...
	function export_lap(){
		...
		// 	param_cabang = "ALL";
		// }else{
		// 	param_cabang = id_cabang;
		// }

		// if(jenis_diklat==""){
		// 	param_jenis = "ALL";
		// }else{
		// 	param_jenis = jenis_diklat;
		// }
		// if(bulan==""){
		// 	param_bulan = "ALL";
		// }else{
		...
		// 	param_dana = "ALL";
		// }else{
		// 	param_dana = sumber_dana;
		// }

		// window.location.href = "<?= site_url('Laporan/export_lap_pemanfaatan_akomodasi/') ?>"+param_cabang+"/"+param_jenis+"/"+param_bulan+"/"+param_tahun+"/"+param_dana;
		window.location.href = "<?= site_url('Laporan/export_laporan_peminjaman/') ?>";
	}
</script>