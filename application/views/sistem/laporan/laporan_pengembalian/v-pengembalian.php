...
<div class="row">
    <div class="col-12">
        <div class="card shade">
            <div class="card-body">
                <h4 class="card-title" style="font-size:17px;"> <i class="bx bx-layer"></i> Laporan Pengembalian</h4>
                <!-- <br> -->
                <br>
                ...
                <h4 style="text-align:center;" > LAPORAN PENGEMBALIAN BUKU </h4>
...
<script>
  ...
  $('#cari').on('keypress', function (e) {
    ...
    if(modeKategori==""){
      ...
      $.ajax({
        url: "<?php echo site_url('Laporan/read_data_pengembalian/')?>" + i,
        type: 'post',
        dataType: 'html',
        data: {
          limit: limit,
  ...
  function refresh(){
    ...
    if(modeKategori==""){
      ...
      window.location.href = "<?= site_url('Laporan/export_laporan_pengembalian/') ?>"+param_bulan+"/"+param_tahun+"/"+param_pertahun+"/"+param_pertanggal+"/"+param_tgl_awal+"/"+param_tgl_akhir;
    }
  }
</script>