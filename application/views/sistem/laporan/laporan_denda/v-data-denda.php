...
<div class="table-responsive">
  <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
    ...
    <tr class="tr-head">
        ...
        <th style="min-width: 160px;" class="sortable" id="column_tgl_pengembalian" data-sort="" onclick="sort_table('#column_tgl_pengembalian','tgl_pengembalian')">Tanggal</th>
    ...
    <tr>
        ...
        <td style="text-align:center;"><?= tgl_indo($row->tgl_pengembalian)?></td>
