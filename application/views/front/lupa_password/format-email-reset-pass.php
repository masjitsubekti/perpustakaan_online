								...
								<tbody>
												...
												<tbody>
													<tr>
														<td align="left" valign="middle" width="50%"><span
																style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">Perpustakaan Online</span>
														</td>
																					...
																					<tr>
																						<td align="center" width="100%"
																							...
																							<h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;"
																								class="title-color">Halo <?=$nama?>,</h3>
																							<p
																								style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">Anda baru saja mengajukan permintaan reset password. Untuk melanjutkan silahkan tekan tombol reset password dibawah ini untuk mereset password anda.</b></p>
																							<div style="font-weight: 200; text-align: center; margin: 25px;">
																								<a href="<?=$root_apl.'/Auth/form_reset/'.$id_user?>" style="padding:0.6em 1em;border-radius:600px;font-size:14px;text-decoration:none;font-weight:bold"
																									class="button-color">Reset Password</a>
																							</div>
																						</td>
																					</tr>
																				</tbody>
                                  ...
                                  <tr>
                                    <td  style="padding-bottom:10px 0px;;">
                                      <small style="font-weight:200;font-family:Helvetica,Arial,sans-serif;font-size:8pt;color:#2C3A47">Keterangan : Abaikan email ini jika Anda tidak merasa melakukan reset password.</small>
                                    </td>
                                  </tr>
																	<tr>
																		<td align="center" style="padding:0 0 20px 0" width="100%"></td>
																	</tr>
																</tbody>
															</table>
														</td>
